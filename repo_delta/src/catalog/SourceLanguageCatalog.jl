...
const CUTLET_SOURCE_CATALOG = (
    ...
    SourceNameEntry(17, :empty_jar, "evskfela ešḑälä’ä"),
)

const MONTH_SOURCE_CATALOG = (
    SourceNameEntry(1, :clay, "andmala"),
    ...
    SourceNameEntry(8, :karshumav, "karšumav"),
    SourceNameEntry(9, :leopard, "arryala"),
    SourceNameEntry(10, :tin, "ažprala"),
    SourceNameEntry(11, :mist, "hwekthaliá-ufthala"),
    ...
    SourceNameEntry(31, :lamp, "alčlila"),
