...
define
   ...
   CutletEntries = [
      ...
      entry(canonicalIndex:17 text:"prazna tegla")
   ]
   ...
   MonthEntries = [
      ...
      entry(canonicalIndex:7  text:"tri dijela od pet")
      ...
      entry(canonicalIndex:31 text:"svjetiljka")
      ...
      entry(canonicalIndex:36 text:"Susa")
