...
pub const MONTH_NAMES: [CatalogEntry; 47] = [
    ...
    CatalogEntry { canonical_index: 4, source_text: "həsəd" },
    ...
    CatalogEntry { canonical_index: 8, source_text: "Karşumav" },
    CatalogEntry { canonical_index: 9, source_text: "bəbir" },
    ...
    CatalogEntry { canonical_index: 30, source_text: "zift" },
    CatalogEntry { canonical_index: 31, source_text: "lampa" },
    ...
    CatalogEntry { canonical_index: 36, source_text: "Susa" },
