...
const
  ...
  CutletCatalog* = [
    ...
    CatalogEntry(canonicalIndex: 4, text: "Lagash"),
  ...
  MonthCatalog* = [
    ...
    CatalogEntry(canonicalIndex: 7, text: "ötből három rész"),
    CatalogEntry(canonicalIndex: 8, text: "Karsumav"),
    ...
    CatalogEntry(canonicalIndex: 30, text: "szurok"),
    CatalogEntry(canonicalIndex: 31, text: "lámpa"),
    ...
    CatalogEntry(canonicalIndex: 36, text: "Szúza"),
