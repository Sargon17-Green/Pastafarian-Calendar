...
(define CUTLET-CATALOG
  (vector
   ...
   (catalog-entry 17 "tuščias stiklainis")))
...
(define MONTH-CATALOG
  (vector
   ...
   (catalog-entry 7 "trys dalys iš penkių")
   (catalog-entry 8 "Karšumav")
   (catalog-entry 9 "leopardas")
