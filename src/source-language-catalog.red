...
make-cutlet-source-names: func [/local out] [
    out: reduce [
        ...
        make object! [canonicalIndex: 4  text: copy "Лагаш"]
        ...
        make object! [canonicalIndex: 17 text: copy "празна тегла"]
    ]
    out
]
...
make-month-source-names: func [/local out] [
    out: reduce [
        ...
        make object! [canonicalIndex: 8  text: copy "Каршумав"]
        ...
        make object! [canonicalIndex: 31 text: copy "лампа"]
        ...
        make object! [canonicalIndex: 36 text: copy "Суса"]
        ...
        make object! [canonicalIndex: 40 text: copy "жаљење"]
