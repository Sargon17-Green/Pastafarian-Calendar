...
package body Source_Language_Catalog is

   type Cutlet_Name_Array is
     array (Cutlet_Canonical_Index) of Unbounded_Wide_Wide_String;
   type Month_Name_Array is
     array (Month_Canonical_Index) of Unbounded_Wide_Wide_String;

   -- అర్థం ఉన్న పేర్లు తెలుగులో అర్థానువాదం చేయబడ్డాయి. ప్రదేశాలు, వ్యక్తి పేర్లు,
   -- ఉద్దేశపూర్వకంగా అర్థంలేని ధ్వని పేర్లు మాత్రమే స్థిరమైన తెలుగు లిప్యంతరణను పొందాయి.
   -- క్రమం ఎల్లప్పుడూ canonicalIndex ద్వారానే నిర్ణయించబడుతుంది; అక్షరక్రమం ద్వారా కాదు.
   -- కేనానికల్ పేర్ల సవరణలో Papyrus Sedge, Karshumav, Lamp, Susa అర్థాలు సరిచేయబడ్డాయి; canonicalIndex క్రమం మారలేదు.
   ...
   Months : constant Month_Name_Array :=
     (1  => To_Unbounded_Wide_Wide_String ("మట్టి"),
      ...
      8  => To_Unbounded_Wide_Wide_String ("కర్షూమవ్"),
      ...
      31 => To_Unbounded_Wide_Wide_String ("దీపం"),
      ...
      36 => To_Unbounded_Wide_Wide_String ("సూసా"),
   ...
   function Cutlet_Name
     (Index : Cutlet_Canonical_Index) return Unbounded_Wide_Wide_String
   is
   begin
   ...
   function Month_Name
     (Index : Month_Canonical_Index) return Unbounded_Wide_Wide_String
   is
   begin
      return Months (Index);
   end Month_Name;
