...
('Karșumav' -: monthNameFromCanonicalIndex 8) check 'transliterarea deterministă Karșumav este fixată'
('mănunchi' -: cutletNameFromCanonicalIndex 9) check 'sensul generic de grup este fixat fără restrângere la struguri'
('borcanul gol' -: cutletNameFromCanonicalIndex 17) check 'sensul de borcan gol este fixat'
('leopard' -: monthNameFromCanonicalIndex 9) check 'Leopard rămâne neschimbat'
('smoală' -: monthNameFromCanonicalIndex 30) check 'Pitch rămâne smoală'
('lampă' -: monthNameFromCanonicalIndex 31) check 'sensul Lamp este fixat'
('Susa' -: monthNameFromCanonicalIndex 36) check 'toponimul Susa este fixat'
('regret' -: monthNameFromCanonicalIndex 40) check 'Regret rămâne neschimbat'
