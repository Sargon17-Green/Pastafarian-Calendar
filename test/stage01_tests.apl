...
∇ RunStage01Tests;counts;ctx;s1;s2;stream;wcount;w1;cutCount1;cutCount2;cutCount3;catalogCopy;tamperedCatalog;tamperedNames;exact0;hidden;visible;bowls;pair;order46;fakeSauce;yearBounds;monthBounds;syntheticYear;syntheticCutlets;syntheticStructure;syntheticFinal;ec;i
  ...
  AssertEqual (⊂'Lampe') (⊂MonthNameByIndex 31) (⊂'Monats-canonicalIndex 31 bewahrt die kanonische Lampenbedeutung')
  AssertEqual (⊂'Susa') (⊂MonthNameByIndex 36) (⊂'Monats-canonicalIndex 36 bewahrt den kanonischen Namen Susa')
  AssertEqual (⊂'Nebel') (⊂MonthNameByIndex 11) (⊂'Monats-canonicalIndex 11 bleibt bewusst Nebel')
