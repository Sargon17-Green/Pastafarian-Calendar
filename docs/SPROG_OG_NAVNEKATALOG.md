# Kildesprog og navnekatalog

## Fast princip

Kanonisk rækkefølge bestemmes kun af `canonicalIndex`. Den danske tekst er en præsentationsværdi og må ikke bruges til rang, åbning af rang, cacheidentitet eller valg.
...
Et eventuelt fremtidigt visningssprog må kun oversætte den danske kildetekst. Det må ikke ændre kanoniske indeks eller påvirke nogen normativ beregning.
