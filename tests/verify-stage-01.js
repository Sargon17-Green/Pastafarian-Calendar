...
group('null textu hebreic o code de patches futur contamina production', () => {
  const root = path.join(__dirname, '..');
...
group('errores de Bootstrap es explicit e li final function resta absent ante Stage 2', () => {
  let captured = null;
  try {
...
console.log('\n' + groupsPassed + ' gruppes de verification passat; ' + assertions + ' assertions passat; Stage 1 resta GREEN.');
