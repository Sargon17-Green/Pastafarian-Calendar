# Katalòg lang sous la

Vèsyon katalòg la se `1.0.0`, epi lang sous la se Kreyòl ayisyen. Apre Stage 1, endis yo ak chèn sous yo konsidere kòm jele sof si gen yon chanjman spesifikasyon ki di lòt bagay klèman.
...
## Lokal ki ta vini pita

Yon lokal pita dwe swiv chèn sa a sèlman:

```text
semantik kanonik -> canonicalIndex -> chèn sous Kreyòl ayisyen -> tradiksyon lokal
```

Li pa dwe janm fè yon tradiksyon retounen nan kalkil la.
