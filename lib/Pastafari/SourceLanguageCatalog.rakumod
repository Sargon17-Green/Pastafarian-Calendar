...
my constant @CUTLET_SOURCE = (
    ...
    { canonicalIndex => 17, text => 'tühi purk' },
);
...
my constant @MONTH_SOURCE = (
    ...
    { canonicalIndex => 7,  text => 'kolm osa viiest' },
